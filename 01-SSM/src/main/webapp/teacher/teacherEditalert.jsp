...
<center>
    ...
    <h1>修改个人资料</h1>
    <form id="f1" action="${pageContext.servletContext.contextPath}/teacher/teacherEdit.action.action" method="post">
        <div class="input-group mb-3">
            <table style="margin-left: 360px">
                <tr>
                    <td><p><h5>用户名:</h5></p></td>
                    <td> <p></p>
                        <input type="text" name="uname" value="${user.uname}" readonly="readonly"  class="form-control"  aria-label="Username" aria-describedby="basic-addon1"></td>
                </tr>
                <tr>
                    <td><p><h5>新密码:</h5></p></td>
                    <td> <p></p>
