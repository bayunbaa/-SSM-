...
public interface AdminService {
    ...
    PageInfo<List<Facility>> findByName(Integer page, String fname, Integer id);
    ...
    PageInfo<List<Addfacility>> findAddfacilityByPlan2(Integer page);
    //查询所有未维修设备信息
    PageInfo<List<Repairs>> findServiceByplan(Integer page);
    PageInfo<List<Addfacility>>  findServiceByplan2(Integer page);
    //查询所有已修的设备信息
    ...
    //查看全部学生的信息
    PageInfo<List<User>> findAdmin(Integer page);
    //需要商品采购
    ...
    void repairPassed(Integer page, String fname, Integer id);
