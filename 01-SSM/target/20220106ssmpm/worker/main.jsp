...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1 style="color: black;">
            <img src="${pageContext.servletContext.contextPath}/images/wei-xiu-ren-yuan.jpg"
...
<div class="leftnav">
    ...
    <ul style="display: block">
        <li><a href="/public/inform.jsp" target="right"><span
    ...
    <ul style="display: block">
        ...
        <li><a href="${pageContext.servletContext.contextPath}/worker/deleteFacility.action" target="right"><span
                class="icon-caret-right"></span>报废设备信息</a></li>
...
<div class="admin">
    <iframe scrolling="auto" rameborder="0" src="${pageContext.servletContext.contextPath}/inform.action" name="right" width="100%" height="100%"></iframe>
</div>
